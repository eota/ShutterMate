...
public class OldDigitalBoardActivity extends AppCompatActivity {
    ImageView a1;
    ImageView a2;
    ImageView a3;
    ImageView a4;
...
//        TextView text = findViewById(R.id.activeFen);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(OldDigitalBoardActivity.this, Pop.class);
...
//                mTextView.setText("That didn't work!");
    ...
    public void showFromIdChar(Integer square, Character piece){
        ImageView newPiece = new ImageView(OldDigitalBoardActivity.this);
